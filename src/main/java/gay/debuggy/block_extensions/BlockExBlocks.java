...
public class BlockExBlocks {
	...
	// General Blocks
	public static final Block BUGGED_PISTON = new Block(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS));
	public static final Block CAST_IRON_BLOCK = new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK));
	public static final Block COBBLESTONE_TILE = new Block(AbstractBlock.Settings.copy(Blocks.STONE));
	public static final Block DECO_BARREL = new Block(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS));
	public static final Block DECO_CHISELED_BOOKSHELF = new Block(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS));
	public static final Block DECO_DAYLIGHT_DETECTOR = new Block(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS));
	public static final Block DECO_JIGSAW = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block DECO_OBSERVER = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block DECO_SMITHING_TABLE = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block FAKE_COMMAND_BLOCK = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block FAKE_CHAIN_COMMAND_BLOCK = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	...
	public static final Block LIME_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.LIME_WOOL));
	public static final Block GREEN_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.GREEN_WOOL));
	public static final Block CYAN_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.CYAN_WOOL));
	public static final Block LIGHT_BLUE_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.LIGHT_BLUE_WOOL));
	public static final Block BLUE_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.BLUE_WOOL));
	public static final Block PURPLE_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.PURPLE_WOOL));
	public static final Block MAGENTA_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.MAGENTA_WOOL));
	public static final Block PINK_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.PINK_WOOL));
	public static final Block BROWN_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.BROWN_WOOL));
	public static final Block BLACK_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.BLACK_WOOL));
	...
	public static final Block ASEXUAL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block BISEXUAL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block DEMIBOY_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block DEMIGIRL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block DISABILITY_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block GAY_MEN_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block GAY_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block GENDERFAE_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block GENDERQUEER_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block LESBIAN_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block NONBINARY_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block PANSEXUAL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block PLURAL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block POLYSEXUAL_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	public static final Block TRANSGENDER_QUILT_PATCH = new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));
	...
	public static void registerBlocks(String blockId, Block block) {
		...
		Registry.register(Registries.ITEM, Identifier.of(MOD_ID, blockId), new BlockItem(block, new Item.Settings()));
